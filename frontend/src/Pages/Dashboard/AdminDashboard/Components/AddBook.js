...
function AddBook() {
    ...
    return (
        <div>
            <p className="dashboard-option-title">Agregar un libro</p>
            <div className="dashboard-title-line"></div>
            <form className='addbook-form' onSubmit={addBook}>

                <label className="addbook-form-label" htmlFor="bookName">Nombre del libro<span className="required-field">*</span></label><br />
                ...
                <label className="addbook-form-label" htmlFor="alternateTitle">Título alternativo</label><br />
                ...
                <label className="addbook-form-label" htmlFor="author">Nombre del autor<span className="required-field">*</span></label><br />
                ...
                <label className="addbook-form-label" htmlFor="language">Idioma</label><br />
                <input className="addbook-form-input" type="text" name="language" value={language} onChange={(e) => { setLanguage(e.target.value) }}></input><br />

                <label className="addbook-form-label" htmlFor="publisher">Editorial</label><br />
                ...
                <label className="addbook-form-label" htmlFor="copies">Nº de copias disponibles<span className="required-field">*</span></label><br />
                ...
                <label className="addbook-form-label" htmlFor="categories">Categorías<span className="required-field">*</span></label><br />
                ...
                <input className="addbook-submit" type="submit" value="ENVIAR" disabled={isLoading}></input>
            </form>
            <div>
                <p className="dashboard-option-title">Libros agregados recientemente</p>
                <div className="dashboard-title-line"></div>
