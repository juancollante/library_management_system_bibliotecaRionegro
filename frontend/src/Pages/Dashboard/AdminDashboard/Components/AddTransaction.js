...
function AddTransaction() {
    ...
    return (
        <div>
            <p className="dashboard-option-title">Agregar transacción</p>
            <div className="dashboard-title-line"></div>
            <form className='transaction-form' onSubmit={addTransaction}>
                <label className="transaction-form-label" htmlFor="borrowerId">Prestatario<span className="required-field">*</span></label><br />
                ...
                <table className="admindashboard-table shortinfo-table" style={borrowerId === "" ? { display: "none" } : {}}>
                    <tr>
                        ...
                        <th>Fecha de inicio<br /><span style={{ fontSize: "10px" }}>[MM/DD/AAAA]</span></th>
                        <th>Fecha de fin<br /><span style={{ fontSize: "10px" }}>[MM/DD/AAAA]</span></th>
                        <th>Multa</th>
                    </tr>
                    {
                ...
                <label className="transaction-form-label" htmlFor="bookName">Nombre del libro<span className="required-field">*</span></label><br />
                <div className='semanticdropdown'>
                    <Dropdown
                ...
                <label className="transaction-form-label" htmlFor="transactionType">Tipo de transacción<span className="required-field">*</span></label><br />
                <div className='semanticdropdown'>
                    <Dropdown
                ...
                <label className="transaction-form-label" htmlFor="from-date">Fecha de inicio<span className="required-field">*</span></label><br />
                <DatePicker
                ...
                <label className="transaction-form-label" htmlFor="to-date">Fecha de fin<span className="required-field">*</span></label><br />
                <DatePicker
                    className="date-picker"
                    placeholderText="MM/DD/AAAA"
                    selected={toDate}
                ...
                <input className="transaction-form-submit" type="submit" value="ENVIAR" disabled={isLoading}></input>
            </form>
            <p className="dashboard-option-title">Transacciones recientes</p>
            <div className="dashboard-title-line"></div>
