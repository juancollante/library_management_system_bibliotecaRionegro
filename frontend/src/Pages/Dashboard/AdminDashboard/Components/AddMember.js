...
function AddMember() {
    ...
    return (
        <div>
            <p className="dashboard-option-title">Agregar miembro</p>
            ...
            <form className="addmember-form" onSubmit={addMember}>
                ...
                <label className="addmember-form-label" htmlFor="userFullName">Nombre completo<span className="required-field">*</span></label><br />
                ...
                <label className="addmember-form-label" htmlFor={userType === "Student" ? "admissionId" : "employeeId"}>{userType === "Student" ? "ID de admisión" : "ID de empleado"}<span className="required-field">*</span></label><br />
                ...
                <label className="addmember-form-label" htmlFor="mobileNumber">Teléfono móvil<span className="required-field">*</span></label><br />
                ...
                <label className="addmember-form-label" htmlFor="gender">Género<span className="required-field">*</span></label><br />
                <div className='semanticdropdown'>
                    <Dropdown
                        placeholder='Género'
                        fluid
                ...
                <label className="addmember-form-label" htmlFor="age">Edad<span className="required-field">*</span></label><br />
                <input className="addmember-form-input" type="text" value={age} required onChange={(e) => setAge(e.target.value)}></input><br />

                <label className="addmember-form-label" htmlFor="dob">Fecha de nacimiento<span className="required-field">*</span></label><br />
                <DatePicker
                ...
                <label className="addmember-form-label" htmlFor="address">Dirección<span className="required-field">*</span></label><br />
                ...
                <label className="addmember-form-label" htmlFor="email">Correo electrónico<span className="required-field">*</span></label><br />
                <input className="addmember-form-input" type="email" value={email} required onChange={(e) => setEmail(e.target.value)}></input><br />

                <label className="addmember-form-label" htmlFor="password">Contraseña<span className="required-field">*</span></label><br />
                <input className="addmember-form-input" type="password" value={password} onChange={(e) => setPassword(e.target.value)}></input><br />

                <input className="addmember-submit" type="submit" value="ENVIAR" disabled={isLoading} ></input>
